    ...
    return (
      <div>
        <nav id="APP_NAV" className="navigation">
          ...
          <a href="/terms" aria-label="Read more about..">
          ...
          <a href="/about" aria-label="Read more about..">
            <svg id="icon-location" viewBox="0 0 32 32">
              <path d="M16 0c-5.523 0-10 4.477-10 10 0 10 10 22 10 22s10-12 10-22c0-5.523-4.477-10-10-10zM16 16c-3.314 0-6-2.686-6-6s2.686-6 6-6 6 2.686 6 6-2.686 6-6 6z" />
            </svg>
          </a>
          <a href="/more" aria-label="Read more about..">
...
const Error = ({ type, url }) => (
  <section class="error">
    ...
    <a href="/" className="navigation" aria-label="Read more about..">
