...
export default class Navbar extends Component {
  componentDidMount() {
    ...
    window.addEventListener("scroll", function(e) {
      if (new_scroll_position < window.scrollY && window.scrollY > 50) {
        document.getElementById("headMenu").classList.add("header__pinned");
        document
          .getElementById("headMenu")
          .classList.remove("header__unpinned");
      } else {
        document.getElementById("headMenu").classList.remove("header__pinned");
        document.getElementById("headMenu").classList.add("header__unpinned");
      }
    });
  }
  ...
  render() {
    return (
      <div>
        ...
        <nav id="headMenu" className="navigation">
          <a href="/">
            <svg>
          ...
          <a href="/more">
            <svg>
              <use xlinkHref="#icon-navigation-more" />
            </svg>
          </a>
        </nav>
      </div>
