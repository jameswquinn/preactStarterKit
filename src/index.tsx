...
const App = () => (
    <main>
        ...
        <nav className="navigation">
            <a href="/"><svg><use xlinkHref="#icon-home"></use></svg></a>
            <a href="/terms"><svg><use xlinkHref="#icon-bubble"></use></svg></a>
            <a href="/about"><svg><use xlinkHref="#icon-location"></use></svg></a>
            <a href="/more"><svg><use xlinkHref="#icon-navigation-more"></use></svg></a>
        </nav>
